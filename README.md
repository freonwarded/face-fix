...
Обычно изменения интерфейса проверяются перед выпуском, а элементы, связанные с оценкой заданий, проектируются с учетом необходимости избежать случайных действий.
